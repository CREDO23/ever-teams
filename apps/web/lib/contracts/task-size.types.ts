...
export const updateTaskSizeRequestSchema = createTaskSizeRequestSchema.partial().extend({
	id: z.string()
});

export const deleteTaskSizeRequestSchema = z.object({
	id: z.string(),
	tenantId: z.string().nullish()
});
...
export type DeleteTaskSizeRequest = z.infer<typeof deleteTaskSizeRequestSchema>;
